...
import { Terminal, Search, ShieldCheck, Scale, Users, DownloadCloud } from "lucide-react";
      ...
      <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-3 px-4 py-3">
        <Link to="/" className="flex items-center gap-2">
          ...
          <span className="font-semibold tracking-tight">
            OS<span className="text-primary"> Oracle</span>
          </span>
        </Link>
        <form
          onSubmit={onSubmit}
        ...
        >
          <div className="relative w-full">
            ...
            <input
              ...
              placeholder='Describe what you want to do — e.g. "audit Wi-Fi security"'
        ...
        <nav className="order-2 flex items-center gap-1 text-sm sm:order-3">
          ...
          <NavLink to="/cli">
            <DownloadCloud className="mr-1 inline h-3.5 w-3.5" />
            CLI
          </NavLink>
          <NavLink to="/ethics">
  ...
  return (
    <footer className="mt-16 border-t border-border">
      <div className="mx-auto max-w-6xl px-4 py-6 text-xs text-muted-foreground">
        <span className="font-semibold text-foreground">OS Oracle</span> — offline-first,
        open-source ethical hacking reference. No AI. No cloud. No telemetry. Content is for
        authorised security testing, learning, and defence only — see{" "}
