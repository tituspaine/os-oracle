...
export const KALI_EXTRA2_TOOLS: KaliTool[] = [
  ...
  tool("arjun", "Arjun", "Web Application Analysis", "arjun", "arjun", "HTTP parameter discovery."),
  tool(
    "paramspider",
    "ParamSpider",
    "Web Application Analysis",
  ...
  tool("smblogin", "smblogin", "Password Attacks", "smblogin", "smblogin", "SMB login checker."),
  tool(
    "winrm-brute",
    "winrm brute (crackmapexec)",
    "Password Attacks",
    "crackmapexec",
    "crackmapexec winrm",
  ...
  tool("jadx", "jadx", "Reverse Engineering", "jadx", "jadx", "Dex to Java decompiler."),
  tool(
    "dex2jar",
    "dex2jar",
    "Reverse Engineering",
  ...
  tool("serpico", "Serpico", "Reporting Tools", "serpico", "serpico", "Pentest report generator."),
  tool(
    "magictree",
    "MagicTree",
    "Reporting Tools",
