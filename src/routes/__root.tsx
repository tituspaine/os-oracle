  ...
  return (
    <div className="flex min-h-[60vh] items-center justify-center px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-1 text-xs text-muted-foreground/60 font-mono">{error?.message}</p>
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "distro/ref — Linux & Kali command reference" },
      {
        ...
        content:
          "Purpose, best use cases, complete command list, and error solutions for every major Linux distro and Kali tool.",
      },
